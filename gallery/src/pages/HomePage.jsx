const HomePage = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6 text-center">Welcome to Image Gallery</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        <div className="flex flex-col items-center bg-white p-6 rounded-xl shadow-lg transition-transform transform hover:scale-105">
          ...
          <p className="text-gray-700 mb-4 text-center">Explore our collection of beautiful couple photographs.</p>
        ...
        <div className="flex flex-col items-center bg-white p-6 rounded-xl shadow-lg transition-transform transform hover:scale-105">
          ...
          <p className="text-gray-700 mb-4 text-center">Discover amazing solo portrait photography.</p>
          <a href="/solo" className="inline-block bg-pink-500 text-white px-6 py-2 rounded-full hover:bg-blue-600 transition">View Gallery</a>
        </div>
      </div>
    </div>
  );
